...
const [starting, setStarting] = useState("")
  ...
  //   setAdminChanges({ ...adminChanges, [e.target.name]: e.target.value });
  // };
    useEffect(() => {
   ...
   const handleChanges = (e) => {
     if(idButton&&status)
           { dispatch(changeStatus(idButton,{status,starting,addsum}))};
  };
  return (
     <>
     {isLoad?(<Spinner/>): null}
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative w-full mb-3">
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    the sum to add after click
                  </label>
                  <input
                    type="text"
                    className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                    placeholder="the sum to add after click"
                    name="addsum"
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  ...
                  <button
                    ...
                    type="button"
                    onClick={(e) => {setShowModal(false);handleChanges()}}
                  >
                    Accept
                  </button>
                </div>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  ...
                  <button
                    ...
                    type="button"
                    onClick={(e) => {setShowModal2(false);handleChanges()}}
                  >
                    Refuse
                  </button>
                </div>
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody key={el._id}>
              <tr>
               ...
               <a href="#modal" role="button" className="button button__link"><button id={el._id}
                // onClick={handleId}
                onClick={(e) => {setShowModal(true);handleId(e)}}
                name="status"
                value="accept"
                ...
                Accept
                  ...
                  <button id={el._id}
                  onClick={(e) => {setShowModal2(true);handleId(e)}}
                  name="status"
                  value="refuse"
